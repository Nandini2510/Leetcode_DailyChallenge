<h2><a href="https://leetcode.com/problems/find-all-the-lonely-nodes/?envType=weekly-question&envId=2024-04-15">1469. Find All The Lonely Nodes</a></h2><h3>Easy</h3><hr><p>In a binary tree, a <strong>lonely</strong> node is a node that is the only child of its parent node. The root of the tree is not lonely because it does not have a parent node.</p>
